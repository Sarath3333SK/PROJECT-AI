...
class dataUploadView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        #print('inside form')
        #['cement','slag','flyash','water','superplasticizer','coarseaggreate','fineaggregate','age']
        if form.is_valid():
            form.save()
            ...
            data_fineaggreagte=request.POST.get('fineaggregate')
        ...
        # Fitting K-NN to the Training set
            ...
            y_pred=reg.predict([[data_cement,data_slag,data_flyash,data_water,data_superplasticizer,data_coarseaggreate,data_fineaggreagte,data_age]])





            return render(request, "succ_msg.html", {'data_cement':data_cement,'data_slag':data_slag,'data_flyash':data_flyash,
                                                    'data_water':data_water,'data_superplasticizer':data_superplasticizer,
                                                    'data_coarseaggreate':data_coarseaggreate,'data_fineaggreagte':data_fineaggreagte,
                                                    'data_age':data_age,'y_pred':y_pred})
